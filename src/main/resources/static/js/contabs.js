 ...
 * @returns {boolean}
 */
function openTab(dataUrl,dataIndex,menuName) {
    var flag = true;

    if (dataUrl == undefined || $.trim(dataUrl).length == 0)return false;

    console.log($(window.parent.document).find('.J_menuTab').length)
    ...
    if (flag) {
        ...
        // 添加选项卡
        $(window.parent.document).find('.J_menuTabs .page-tabs-content').append(str);
