...
$(function() {
    ...
    $.post('/metadata/relationInfo/nodeJson/'+$("#source_db_name").val()+'/'+$("#source_table_name").val(), { "tableId": "" }, function(data) {
